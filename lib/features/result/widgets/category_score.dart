...
/// Provider for managing category scores (if dynamic logic is needed in the future)
final categoryScoresProvider = StateProvider<List<Map<String, dynamic>>>((ref) {
  return []; // Default empty list, this will be set dynamically when data is available
});

class SurveyCategoryScore extends ConsumerWidget {
