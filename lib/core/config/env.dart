...
/// Env configuration for Shwapno Survey.
/// - By default (when you just click ▶ Run in Android Studio), it uses LOCAL URLs.
/// - For production builds, set ENV=prod (`flutter build ... --dart-define=ENV=prod`).
class Env {
  /// "prod" | "dev" | "local"
  ...
  static const _centralAuthOverride =
  String.fromEnvironment('CENTRAL_AUTH_BASE_URL', defaultValue: '');
  static const _surveyOverride =
  String.fromEnvironment('SURVEY_BASE_URL', defaultValue: '');

  /// Logging toggle (default: true unless release/prod)
  static const _logNetworkOverride =
  String.fromEnvironment('LOG_NETWORK', defaultValue: '');
  ...
  static String get centralAuthBaseUrl {
    ...
    return _centralAuthByEnv[env.toLowerCase()] ??
        _centralAuthByEnv['prod']!;
  }
  ...
  static String get surveyBaseUrl {
    ...
    return _surveyByEnv[env.toLowerCase()] ??
        _surveyByEnv['prod']!;
  }
